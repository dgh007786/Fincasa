...
import shape1 from '/public/images/progress-shape-1.png';
import shape2 from '/public/images/progress-shape-2.png';
...
const Skill2 = (props) => {
    return (
        <section className="wpo-skill-section-s2 section-padding">
            ...
            <div className="pr-shape-1"><Image src={shape1} alt=""/></div>
            <div className="pr-shape-2"><Image src={shape2} alt=""/></div>
        </section>
    )
}
